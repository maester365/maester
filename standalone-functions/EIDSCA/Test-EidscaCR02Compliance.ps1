function Test-EidscaCR02Compliance {
    ...
    try {
        ...
        $actualValue = $response.notifyReviewers
    } catch {
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA CR02: Compliant"
    } else {
        Write-Verbose "EIDSCA CR02: Non-Compliant - Expected: true, Actual: $actualValue"
    }
