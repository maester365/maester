function Test-EidscaAF01Compliance {
    <#
    .SYNOPSIS
    Authentication Method - FIDO2 security key - State

    .DESCRIPTION
    Validates EIDSCA control AF01.
    Returns true if compliant, false if non-compliant, null if skipped or error.

    .EXAMPLE
    $result = Test-EidscaAF01Compliance
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA AF01: Compliant"
    } else {
        Write-Verbose "EIDSCA AF01: Non-Compliant - Expected: enabled, Actual: $actualValue"
    }
