function Test-EidscaAF05Compliance {
    <#
    .SYNOPSIS
    Authentication Method - FIDO2 security key - Restricted

    .DESCRIPTION
    Validates EIDSCA control AF05.
    Returns true if compliant, false if non-compliant, null if skipped or error.

    .EXAMPLE
    $result = Test-EidscaAF05Compliance
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA AF05: Compliant"
    } else {
        Write-Verbose "EIDSCA AF05: Non-Compliant - Expected: true, Actual: $actualValue"
    }
