function Test-EidscaPR01Compliance {
    <#
    .SYNOPSIS
    Default Settings - Password Rule Settings - Password Protection - Mode

    .DESCRIPTION
    Validates EIDSCA control PR01.
    Returns true if compliant, false if non-compliant, null if skipped or error.

    .EXAMPLE
    $result = Test-EidscaPR01Compliance
    ...
    $testResult = $actualValue -eq 'Enforce'

    # Phase 4: Return Result
    if ($testResult) {
        Write-Verbose "EIDSCA PR01: Compliant"
    } else {
        Write-Verbose "EIDSCA PR01: Non-Compliant - Expected: Enforce, Actual: $actualValue"
    }
