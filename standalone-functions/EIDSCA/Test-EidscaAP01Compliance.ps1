function Test-EidscaAP01Compliance {
    ...
    try {
        ...
        $actualValue = $response.allowedToUseSSPR
    } catch {
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA AP01: Compliant"
    } else {
        Write-Verbose "EIDSCA AP01: Non-Compliant - Expected: false, Actual: $actualValue"
    }
