function Test-EidscaST08Compliance {
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA ST08: Compliant"
    } else {
        Write-Verbose "EIDSCA ST08: Non-Compliant - Expected: false, Actual: $actualValue"
    }
