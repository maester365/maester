function Test-EidscaAP14Compliance {
    ...
    try {
        ...
        $actualValue = $response.defaultUserRolePermissions.allowedToReadOtherUsers
    } catch {
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA AP14: Compliant"
    } else {
        Write-Verbose "EIDSCA AP14: Non-Compliant - Expected: true, Actual: $actualValue"
    }
