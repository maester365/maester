function Test-EidscaAG03Compliance {
    ...
    try {
        ...
        $actualValue = $response.reportSuspiciousActivitySettings.includeTarget.id
    } catch {
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA AG03: Compliant"
    } else {
        Write-Verbose "EIDSCA AG03: Non-Compliant - Expected: all_users, Actual: $actualValue"
    }
