function Test-EidscaAM07Compliance {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
    Validates EIDSCA control AM07.
    Returns true if compliant, false if non-compliant, null if skipped or error.

    .EXAMPLE
    $result = Test-EidscaAM07Compliance
    ...
    try {
        ...
        $actualValue = $response.featureSettings.displayAppInformationRequiredState.includeTarget.id
    } catch {
    ...
    if ($testResult) {
        Write-Verbose "EIDSCA AM07: Compliant"
    } else {
        Write-Verbose "EIDSCA AM07: Non-Compliant - Expected: all_users, Actual: $actualValue"
    }
