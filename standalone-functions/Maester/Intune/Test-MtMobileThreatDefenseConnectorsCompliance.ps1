function Test-MtMobileThreatDefenseConnectorsCompliance {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    $result = Test-MtMobileThreatDefenseConnectorsCompliance
    ...
    try {
        ...
        $mobileThreatDefenseConnectors = Invoke-MgGraphRequest -Uri 'https://graph.microsoft.com/beta/deviceManagement/mobileThreatDefenseConnectors'
