function Test-MtEntitlementManagementValidApproversCompliance {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    $result = Test-MtEntitlementManagementValidApproversCompliance
    ...
    try {
        ...
        foreach ($package in $packages) {
            ...
            try {
                $policies = Invoke-MgGraphRequest -Uri 'https://graph.microsoft.com/v1.0/identityGovernance/entitlementManagement/accessPackageAssignmentPolicies?`$filter=accessPackage/id eq '$packageId'" -ApiVersion beta
                        ...
                        foreach ($approver in $primaryApprovers) {
                            ...
                            switch ($approverType) {
                                '#microsoft.graph.singleUser' {
                                    ...
                                    try {
                                        $user = Invoke-MgGraphRequest -Uri 'https://graph.microsoft.com/beta/users/$userId' -ErrorAction SilentlyContinue
                                ...
                                '#microsoft.graph.groupMembers' {
                                    ...
                                    try {
                                        $group = Invoke-MgGraphRequest -Uri 'https://graph.microsoft.com/beta/groups/$groupId' -ErrorAction SilentlyContinue
                                        ...
                                        try {
                                            $members = Invoke-MgGraphRequest -Uri 'https://graph.microsoft.com/beta/groups/$groupId/members?`$top=1' -ErrorAction SilentlyContinue
