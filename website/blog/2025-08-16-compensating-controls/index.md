...
> 💡 Callout
>
> Governance terminology (e.g., frameworks, policies, and standards) is used in many contexts with different meanings. For example, the United States National Institute of Standards and Technology (NIST) publishes the Special Publication (SP) 1800 series as **guidelines**, although these publications are often described as standards. Standards bodies cover many fields: the OpenID Foundation (OIDF) creates secure, interoperable, and privacy-preserving identity standards, while ASTM International provides resources for standards development and use worldwide. This also highlights the distinction between internal and external standards. External standards are typically consensus-driven by an industry working group around common implementation specifications, whereas internal standards define an organization's specific implementation requirements.
