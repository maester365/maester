---
title: Maester v1.1
description: Maester v1.1 release notes
slug: maester-v1
authors: merill
tags: [release]
...
![Maester - v1.1](./img/maester-v1.png)
## TODO : Change image to v1.1

{/* truncate */}

Here's a list of all the new features and improvements in Maester v1.1.

* 67 New Defender for Office 365 tests based on [ORCA](https://github.com/cammurray/orca). Thanks to Mike Soule, Thomas Schmidt, and ...?? for their contributions.
* New application risk tests based on the [Azure Tiering](https://github.com/emiliensocchi/azure-tiering) research by Emilien Socchi. Thanks to ... (to be verified) for their contributions.
...
* More new Maester tests for
  * Intune
  * Group security settings
* Export Results to CSV and Excel. Thanks to [Sam Erde]()
* Azure DevOps with Web App Integration. Thanks to ...
* BitBucket Integration. Thanks to
