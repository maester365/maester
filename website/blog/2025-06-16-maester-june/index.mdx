...
Check the [Severity Levels documentation](/docs/configuration/severity-levels) for all the details including how you can add Severity to your custom tests.
