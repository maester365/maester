...
The application risk tests are based on the excellent Azure Tiering research by [Emilien Socchi](https://github.com/emiliensocchi/azure-tiering). These help identity apps that have a path to Global Administrator permissions, which can lead to a full tenant takeover.
