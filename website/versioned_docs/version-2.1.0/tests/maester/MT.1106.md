...
- Pester test: `tests/Maester/Entra/Test-MtEntitlementManagementValidResourceRoles.Tests.ps1`
- PowerShell source: `powershell/public/maester/entra/Test-MtEntitlementManagementValidResourceRoles.ps1`
