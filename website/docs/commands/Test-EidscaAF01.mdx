...
id: Test-EidscaAF01
title: Test-EidscaAF01
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAF01.ps1
---
...
```powershell
Test-EidscaAF01 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
