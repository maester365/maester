...
id: Send-MtSummaryMail
title: Send-MtSummaryMail
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Send-MtSummaryMail.ps1
---
...
```powershell
Send-MtSummaryMail [-MaesterResults] <PSObject> [-Recipients] <String[]> [-Subject <String>]
 [-TestResultsUri <String>] [-UserId <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
