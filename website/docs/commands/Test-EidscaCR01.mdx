...
id: Test-EidscaCR01
title: Test-EidscaCR01
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaCR01.ps1
---
...
```powershell
Test-EidscaCR01 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
