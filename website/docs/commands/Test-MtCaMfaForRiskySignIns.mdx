...
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-MtCaMfaForRiskySignIns.ps1
---
...
```powershell
Test-MtCaMfaForRiskySignIns [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
