...
```powershell
Convert-MtResultsToFlatObject [-JsonFilePath] <String> [-ExportCsv] [-CsvFilePath <String>]
...
```powershell
Convert-MtResultsToFlatObject [-InputObject] <PSObject> [-JsonFilePath] <String> [-ExportCsv]
 [-ExcelFilePath <String>] [-Force] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
```powershell
Convert-MtResultsToFlatObject [-InputObject] <PSObject> [-ExportCsv] [-CsvFilePath <String>]
 [-ExcelFilePath <String>] [-Force] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
