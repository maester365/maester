...
```powershell
Convert-MtResultsToFlatObject [-MaesterResults] <PSObject> [-ExportCsv] [-CsvFilePath <String>] [-ExportExcel]
...
```powershell
Convert-MtResultsToFlatObject [-JsonFilePath] <String> [-ExportCsv] [-CsvFilePath <String>] [-ExportExcel]
 [-ExcelFilePath <String>] [-Force] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
