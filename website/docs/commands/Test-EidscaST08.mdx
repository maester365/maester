...
id: Test-EidscaST08
title: Test-EidscaST08
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaST08.ps1
---
...
```powershell
Test-EidscaST08 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
