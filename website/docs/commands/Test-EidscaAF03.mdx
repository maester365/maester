...
id: Test-EidscaAF03
title: Test-EidscaAF03
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAF03.ps1
---
...
```powershell
Test-EidscaAF03 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
