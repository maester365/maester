...
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Get-MtRegistrableDomain.ps1
---
...
[https://maester.dev/docs/commands/Get-MtRegistrableDomain](https://maester.dev/docs/commands/Get-MtRegistrableDomain)
