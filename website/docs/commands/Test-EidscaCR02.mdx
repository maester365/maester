...
id: Test-EidscaCR02
title: Test-EidscaCR02
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaCR02.ps1
---
...
```powershell
Test-EidscaCR02 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
