...
id: Test-EidscaAM09
title: Test-EidscaAM09
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAM09.ps1
---
...
```powershell
Test-EidscaAM09 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
