...
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-MtCaMfaForGuests.ps1
---
...
```powershell
Test-MtCaMfaForGuests [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
