...
id: Test-EidscaAM01
title: Test-EidscaAM01
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAM01.ps1
---
...
```powershell
Test-EidscaAM01 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
