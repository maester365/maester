...
id: Test-EidscaAM10
title: Test-EidscaAM10
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAM10.ps1
---
...
```powershell
Test-EidscaAM10 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
