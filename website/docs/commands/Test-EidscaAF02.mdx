...
id: Test-EidscaAF02
title: Test-EidscaAF02
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAF02.ps1
---
...
```powershell
Test-EidscaAF02 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
