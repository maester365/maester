...
description: Checks if Default Authorization Settings - User can joint the tenant by email validation is set to 'false'
id: Test-EidscaAP06
title: Test-EidscaAP06
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAP06.ps1
---
...
```powershell
Test-EidscaAP06 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
