...
Active DNS name for the DKIM record to retrieve.

Assuming selector1 is active:
For Microsoft domain it's: (Get-DkimSigningConfig -Identity contoso.onmicrosoft.com).Selector1CNAME
For custom domain it's: selector1._domainkey.contoso.com
