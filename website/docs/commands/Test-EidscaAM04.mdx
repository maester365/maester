...
id: Test-EidscaAM04
title: Test-EidscaAM04
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Test-EidscaAM04.ps1
---
...
```powershell
Test-EidscaAM04 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
