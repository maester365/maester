...
description: Verifies that signature definitions are checked and updated before running a scan.
slug: /tests/MT.1160
...
Verifies that signature definitions are checked and updated before running a scan.
