---
title: "MT.1209 - Agent Identities and Blueprint Principals should not be assigned privileged Entra directory roles"
...
# MT.1209 - Agent Identities and Blueprint Principals should not be assigned privileged Entra directory roles
...
| Tags | Agent ID, Entra, Graph, Maester, MT.1209, Preview, Severity:High |
