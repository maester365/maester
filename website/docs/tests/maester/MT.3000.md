---
title: "MT.3000 - Agent Identity Blueprint Principals should have an existing Blueprint"
...
# MT.3000 - Agent Identity Blueprint Principals should have an existing Blueprint
...
| Tags | Agent ID, Entra, Graph, Maester, MT.3000, Preview, Severity:Medium |
