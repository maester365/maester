...
description: "Ensure a Microsoft Purview Insider Risk Management policy from the **Risky AI usage** template is enabled so risky Microsoft 365 Copilot and AI-app interactions generate triageable alerts. The Risky AI usage template detects: - Prompts attempting to **jailbreak** or bypass system prompts. - Prompts…"
slug: /tests/MT.1174
...
- PowerShell source: `powershell/public/maester/purview/Test-MtPurviewAiInsiderRiskPolicy.ps1`
