---
title: "MT.1200 - Agent Identities should have an active Agent Identity Blueprint Principal (Preview)"
...
# MT.1200 - Agent Identities should have an active Agent Identity Blueprint Principal (Preview)
