---
title: "MT.1215 - Ensure Gatekeeper restricts macOS app download locations"
description: "Ensure macOS devices are restricted to trusted app download locations by Gatekeeper. Gatekeeper decides which app download locations are permitted on macOS. Intune can address it two ways, and this check credits either: - A **macOS compliance policy** evaluates the device's current Gatekeeper state…"
slug: /tests/MT.1215
...
- PowerShell source: `powershell/public/maester/intune/Test-MtMacOSGatekeeper.ps1`
