---
title: MDE.AV23 - Catch-up Full Scan should be disabled
description: Verifies that catch-up full scan is disabled to avoid excessive system load when devices come back online after being offline.
slug: /tests/MDE.AV23
...
Verifies that catch-up full scan is disabled to avoid excessive system load when devices come back online after being offline.
