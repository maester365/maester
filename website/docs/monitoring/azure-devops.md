...
:::warning
Client secret authentication is not recommended for long-term automation, and it´s preferred that you use workload identity federation when possible. Client secrets expire, require manual rotation and manual updates in your pipeline/repository variables.
:::
