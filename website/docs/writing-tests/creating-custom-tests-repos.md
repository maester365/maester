...
Browse more community-maintained repositories - and add your own - on the [Community Tests](/community-tests) page.

## Learn more

- [Install-MtCustomTests command reference](pathname:///docs/next/commands/Install-MtCustomTests) <!-- generated by Update-CommandReference.ps1; not yet run for this unreleased command -->
