...
function Set-OrcaGeneratedContent {
    param (
        [Parameter(Mandatory)]
        [string] $Path,
...
foreach ($prereq in $prereqs) {
    ...
    if ($function) {
        ...
        Set-OrcaGeneratedContent -Path "$repo\powershell\internal\orca\$($prereq.name).ps1" -Value $function
    }
}
...
Set-OrcaGeneratedContent -Path $repo\powershell\internal\orca\orcaClass.psm1 -Value $orcaClassContent
...
foreach ($file in $testFiles) {
    ...
    # Script Files
    Set-OrcaGeneratedContent -Path "$repo\powershell\internal\orca\$($content.file)" -Value $content.content
...
"@
    ...
    # Test Files
    Set-OrcaGeneratedContent -Path "$repo\tests\orca\Test-$($content.func).Tests.ps1" -Value $testScript
...
"@
    ...
    # Test Files
    Set-OrcaGeneratedContent -Path "$repo\powershell\public\orca\Test-$($content.func).ps1" -Value $funcScript
...
"@
    ...
    # MD Files
    Set-OrcaGeneratedContent -Path "$repo\powershell\public\orca\Test-$($content.func).md" -Value $md
}
@"
ScriptsToProcess = @(
