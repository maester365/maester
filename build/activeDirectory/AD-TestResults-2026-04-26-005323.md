...
**Date:** 2026-04-26T00:53:23.6327717+00:00
...
| AD-DACL-13: Privileged extended right identities should be retrievable |  | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
| AD-DACL-14: Non-inherited ACE count should be retrievable |  | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
| AD-DACL-15: Unresolved SID count should be retrievable |  | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
| AD-DACL-16: Unresolved SID details should be retrievable |  | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
| AD-DACL-17: Inherited object type count should be retrievable |  | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
| AD-DACL-18: Inherited object type details should be retrievable |  | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
...
| AD-GPO-03: GPO stale-before-2020 count should be retrievable |  | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
...
Active Directory DACL data has been analyzed. 196 distinct object(s) have one or more DACL entries available for review.
...
Active Directory DACL data has been filtered to Organizational Unit objects. 170 DACL entries were found across 5 OU object(s).
...
Active Directory DACL inheritance was analyzed. 1444 ACE(s) are explicitly assigned and not inherited.
...
Active Directory DACL identities were analyzed. 12 unresolved SID reference(s) were found across 913 ACE(s).
...
Active Directory DACL entries were analyzed for orphaned SID references. 196 object(s) contain unresolved SID ACEs.
...
Active Directory DACL inheritance targets were analyzed. 4 distinct inherited object type GUID(s) were referenced across 3192 ACE(s).
...
[OK] No stale GPOs were detected (no GPOs have a ModificationTime earlier than 2020-01-01). Continue periodic reviews to ensure security configurations remain current.
...
[WARN] Unlinked/orphaned GPOs were found. These GPOs consume resources while providing no effective policy, and they can be accidentally linked later, applying unknown settings. After verification, remove or remediate unlinked GPOs.
...
[WARN] Unlinked/orphaned GPOs were found (2). Review these policies for removal to reduce GPO sprawl and lower risk from unused (and potentially misconfigured) policies.
...
Active Directory Group Policy Objects have been analyzed. The domain contains 2 GPO(s); 0 GPO(s) are linked and active across at least one scope (domain, OU, or site).
...
Unable to retrieve Active Directory GPO report data from Get-MtADGpoState.
...
[WARN] One or more Active Directory targets do not have any GPO links (5). Unlinked targets can indicate incomplete policy coverage, leading to inconsistent security enforcement across the environment.
...
[OK] No enforced GPO links (inheritance-blocking links) were detected. Active Directory Group Policy Objects have been analyzed successfully.
...
Active Directory Organizational Units have been analyzed. 1 out of 5 OUs have GPO links.
...
[OK] No GPO reports were found with missing permissions. Active Directory GPO permissions were analyzed successfully.
...
[OK] No GPO reports were found with missing permissions.
...
[OK] No GPO reports were found missing Authenticated Users. GPO permissions were analyzed successfully.
...
[OK] No GPO reports were found missing Authenticated Users.
...
[OK] No GPO reports were found missing Enterprise Domain Controllers.
...
[OK] No GPO reports were found missing Domain Computers.
...
[OK] No GPO reports include a Deny ACE.
...
[OK] No GPO reports were found using inherited permissions.
...
[OK] No GPOs with WMI filter configuration were found.
...
[OK] No GPOs with computer settings disabled were found.
...
[OK] No GPOs with user settings disabled were found.
...
[OK] No GPOs with all settings disabled were found.
