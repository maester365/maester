...
**Date:** 2026-04-25T23:05:30.1062091+00:00
...
âš ï¸ **Design Notice**: 1 domain controller(s) hold all 5 FSMO roles. Consider distributing roles for redundancy.
...
âœ… **Standard Configuration**: All 1 domain controller(s) are using the standard LDAP port (389).
...
âœ… **Standard Configuration**: All 1 domain controller(s) are using the standard LDAPS port (636).
...
| Using Default | True |
| Forest Name | maester.test |
| Recommendation | âœ… Meets recommendation (180+ days) |
...
| Forest Name | maester.test |
| Forest Functional Level | Windows2016Forest |
| Status | âš ï¸ Disabled - Deleted objects can only be recovered through tombstone reanimation or backup restore |
...
âœ… GPO inheritance blocking was not detected on any OU. Active Directory Group Policy Objects have been analyzed successfully.
...
âœ… Password history count meets or exceeds the recommended minimum of 24.
...
âœ… Maximum password age meets the recommendation of 90 days or less.
...
âš ï¸ Minimum password length is below the recommended 14 characters. Consider increasing this to improve resistance against brute-force attacks.
...
âœ… Password complexity is enabled. This helps prevent the use of common, easily guessable passwords.
...
âœ… Reversible encryption is disabled. This is the secure configuration as passwords are stored using one-way hashing.
...
âŒ Account lockout is disabled. This allows unlimited password attempts, making brute-force attacks trivial. Enable account lockout immediately.
