...
@{
    ...
    FunctionsToExport    = @(
        ...
        'Get-MtGraphScope', 'Get-MtGroupMember', 'Get-MtHtmlReport', 'Get-MtLicenseInformation', 'Get-MtMaesterApp',
        'Get-MtMdeConfig', 'Get-MtMdeConfiguration', 'Get-MtMdeDeviceCount', 'Get-MtRole',
        ...
        'Test-MtMdePolicyHasAssignment', 'Test-MtMdePuaProtection', 'Test-MtMdeQuickScanTime',
