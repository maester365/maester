...
* [Learn - Allow extensions to access resources on the local network](https://learn.microsoft.com/azure/devops/marketplace/allow-extensions-local-network?view=azure-devops)
