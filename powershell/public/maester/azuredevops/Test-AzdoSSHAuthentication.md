...
* [Learn - Authentication with Azure Repos](https://learn.microsoft.com/azure/devops/repos/git/auth-overview?view=azure-devops&source=recommendations&tabs=Windows)
