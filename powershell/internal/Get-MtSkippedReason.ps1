...
function Get-MtSkippedReason {
    ...
    switch($SkippedBecause){
        ...
        "NotEnoughLicenseExoDelicensingResiliency" { "Not enough non-trial licenses. See [Delicensing Resiliency](https://learn.microsoft.com/en-us/Exchange/recipients-in-exchange-online/manage-user-mailboxes/exchange-online-delicensing-resiliency)"; break}
