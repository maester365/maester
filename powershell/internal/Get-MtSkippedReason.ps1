function Get-MtSkippedReason {
    ...
    switch ($SkippedBecause) {
        ...
        "NotConnectedSharePointOnline" { "Not connected to SharePoint Online. See [Connecting to SharePoint Online](https://maester.dev/docs/connect-maester/#connect-to-sharepoint-online-optional)"; break }
