# MS.AAD: Checks if group owners can consent to apps

## Overview

**Function Name:** `Test-MtCisaAppGroupOwnerConsent`
**Category:** CISA/Entra
**Test Tag:** `MS.AAD`
...
See the standalone compliance check function: [`Test-MtCisaAppGroupOwnerConsentCompliance.ps1`](../../standalone-functions/CISA/Entra/Test-MtCisaAppGroupOwnerConsentCompliance.ps1)
