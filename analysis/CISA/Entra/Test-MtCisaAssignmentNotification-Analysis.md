# MS.AAD: Checks for notification on role assignments

## Overview

**Function Name:** `Test-MtCisaAssignmentNotification`
**Category:** CISA/Entra
**Test Tag:** `MS.AAD`
...
See the standalone compliance check function: [`Test-MtCisaAssignmentNotificationCompliance.ps1`](../../standalone-functions/CISA/Entra/Test-MtCisaAssignmentNotificationCompliance.ps1)
