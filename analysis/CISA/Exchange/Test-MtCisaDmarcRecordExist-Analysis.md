# MS.EXO: Checks state of DMARC records for all exo second level domains

## Overview

**Function Name:** `Test-MtCisaDmarcRecordExist`
...
See the standalone compliance check function: [`Test-MtCisaDmarcRecordExistCompliance.ps1`](../../standalone-functions/CISA/Exchange/Test-MtCisaDmarcRecordExistCompliance.ps1)
