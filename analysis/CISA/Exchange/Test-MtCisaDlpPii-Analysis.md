# MS.EXO: Checks state of DLP for EXO

## Overview

**Function Name:** `Test-MtCisaDlpPii`
...
See the standalone compliance check function: [`Test-MtCisaDlpPiiCompliance.ps1`](../../standalone-functions/CISA/Exchange/Test-MtCisaDlpPiiCompliance.ps1)
