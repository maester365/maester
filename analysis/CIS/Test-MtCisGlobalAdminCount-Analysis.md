# CIS.M365.1.1.3: Checks if the number of Global Admins is between 2 and 4

## Overview

**Function Name:** `Test-MtCisGlobalAdminCount`
**Category:** CIS
**Test Tag:** `CIS.M365.1.1.3`
...
See the standalone compliance check function: [`Test-MtCisGlobalAdminCountCompliance.ps1`](../../standalone-functions/CIS/Test-MtCisGlobalAdminCountCompliance.ps1)
