# CIS.M365.3.1.1: Checks if audit log search is enabled

## Overview

**Function Name:** `Test-MtCisAuditLogSearch`
**Category:** CIS
**Test Tag:** `CIS.M365.3.1.1`
...
See the standalone compliance check function: [`Test-MtCisAuditLogSearchCompliance.ps1`](../../standalone-functions/CIS/Test-MtCisAuditLogSearchCompliance.ps1)
