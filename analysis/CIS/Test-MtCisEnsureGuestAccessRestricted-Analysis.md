# CIS.M365.5.1.6.2: Checks if guest user access is restricted.

## Overview

**Function Name:** `Test-MtCisEnsureGuestAccessRestricted`
**Category:** CIS
**Test Tag:** `CIS.M365.5.1.6.2`
...
See the standalone compliance check function: [`Test-MtCisEnsureGuestAccessRestrictedCompliance.ps1`](../../standalone-functions/CIS/Test-MtCisEnsureGuestAccessRestrictedCompliance.ps1)
