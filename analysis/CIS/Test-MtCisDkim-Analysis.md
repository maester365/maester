# CIS.M365.2.1.9: Checks state of DKIM for all EXO domains

## Overview

**Function Name:** `Test-MtCisDkim`
**Category:** CIS
**Test Tag:** `CIS.M365.2.1.9`
...
See the standalone compliance check function: [`Test-MtCisDkimCompliance.ps1`](../../standalone-functions/CIS/Test-MtCisDkimCompliance.ps1)
