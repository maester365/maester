# CIS.M365.2.1.7: Checks if the anti-phishing policy matches CIS recommendations

## Overview

**Function Name:** `Test-MtCisSafeAntiPhishingPolicy`
**Category:** CIS
**Test Tag:** `CIS.M365.2.1.7`
...
See the standalone compliance check function: [`Test-MtCisSafeAntiPhishingPolicyCompliance.ps1`](../../standalone-functions/CIS/Test-MtCisSafeAntiPhishingPolicyCompliance.ps1)
