# CIS.M365.4.1: Checks if devices without a compliance policy assigned are marked "not compliant".

## Overview

**Function Name:** `Test-MtCisDevicesWithoutCompliancePolicyMarked`
**Category:** CIS
**Test Tag:** `CIS.M365.4.1`
...
See the standalone compliance check function: [`Test-MtCisDevicesWithoutCompliancePolicyMarkedCompliance.ps1`](../../standalone-functions/CIS/Test-MtCisDevicesWithoutCompliancePolicyMarkedCompliance.ps1)
