# CIS.M365.5.2.3.5: Checks if weak authentication methods (SMS, voice call, email OTP) are disabled in the tenant.

## Overview

**Function Name:** `Test-MtCisWeakAuthenticationMethodsDisabled`
**Category:** CIS
**Test Tag:** `CIS.M365.5.2.3.5`
...
See the standalone compliance check function: [`Test-MtCisWeakAuthenticationMethodsDisabledCompliance.ps1`](../../standalone-functions/CIS/Test-MtCisWeakAuthenticationMethodsDisabledCompliance.ps1)
