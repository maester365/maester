# ORCA: Each domain has a Safe Link policy applied to it.

## Overview

**Function Name:** `Test-ORCA226`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA226Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA226Compliance.ps1)
