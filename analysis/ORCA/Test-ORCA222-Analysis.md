# ORCA: Domain Impersonation action is set to move to Quarantine.

## Overview

**Function Name:** `Test-ORCA222`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA222Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA222Compliance.ps1)
