# ORCA: High Confidence Spam action set to Quarantine message.

## Overview

**Function Name:** `Test-ORCA140`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA140Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA140Compliance.ps1)
