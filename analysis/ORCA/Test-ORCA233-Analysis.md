# ORCA: Domains are pointed directly at EOP or enhanced filtering is used.

## Overview

**Function Name:** `Test-ORCA233`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA233Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA233Compliance.ps1)
