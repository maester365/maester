# ORCA: Each domain has a Anti-phishing policy applied to it, or the default policy is being used.

## Overview

**Function Name:** `Test-ORCA230`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA230Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA230Compliance.ps1)
