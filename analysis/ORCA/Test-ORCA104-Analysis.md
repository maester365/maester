# ORCA: High Confidence Phish action set to Quarantine message.

## Overview

**Function Name:** `Test-ORCA104`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA104Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA104Compliance.ps1)
