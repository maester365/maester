# ORCA: Phish action set to Quarantine message.

## Overview

**Function Name:** `Test-ORCA142`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA142Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA142Compliance.ps1)
