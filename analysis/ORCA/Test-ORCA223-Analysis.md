# ORCA: User impersonation action is set to move to Quarantine.

## Overview

**Function Name:** `Test-ORCA223`
**Category:** ORCA
**Test Tag:** `ORCA`
...
See the standalone compliance check function: [`Test-ORCA223Compliance.ps1`](../../standalone-functions/ORCA/Test-ORCA223Compliance.ps1)
