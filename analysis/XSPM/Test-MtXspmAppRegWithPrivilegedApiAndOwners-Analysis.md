# Test-MtXspmAppRegWithPrivilegedApiAndOwners: Tests if app registration owners with privileged API permissions have delegated ownership.

## Overview

**Function Name:** `Test-MtXspmAppRegWithPrivilegedApiAndOwners`
**Category:** XSPM
...
See the standalone compliance check function: [`Test-MtXspmAppRegWithPrivilegedApiAndOwnersCompliance.ps1`](../../standalone-functions/XSPM/Test-MtXspmAppRegWithPrivilegedApiAndOwnersCompliance.ps1)
