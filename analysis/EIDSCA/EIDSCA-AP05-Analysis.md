...
EIDSCA.AP05: Default Authorization Settings - Sign-up for email based subscription. See https://maester.dev/docs/tests/EIDSCA.AP05
...
flowchart TD
    ...
    D -->|allowedToSignUpEmailBasedSubscriptions| E{Validate Value}
...
- **Property Path:** `allowedToSignUpEmailBasedSubscriptions`

### Phase 3: Compliance Validation

| Property | Comparison | Expected Value |
| --- | --- | --- |
| `allowedToSignUpEmailBasedSubscriptions` | `-Be` | `false` |
...
See: [`Test-EidscaAP05Compliance.ps1`](../../standalone-functions/EIDSCA/Test-EidscaAP05Compliance.ps1)