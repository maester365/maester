# Test-MtLimitOnMicrosoftDomainUsage: Ensure mailboxes do not use the .onmicrosoft.com domain as primary SMTP address

## Overview

**Function Name:** `Test-MtLimitOnMicrosoftDomainUsage`
...
See the standalone compliance check function: [`Test-MtLimitOnMicrosoftDomainUsageCompliance.ps1`](../../standalone-functions/Maester/Exchange/Test-MtLimitOnMicrosoftDomainUsageCompliance.ps1)
