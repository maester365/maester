# Test-MtEntraIDConnectSyncSoftHardMatching: Ensure soft and hard matching for on-premises synchronization objects is blocked

## Overview

**Function Name:** `Test-MtEntraIDConnectSyncSoftHardMatching`
...
See the standalone compliance check function: [`Test-MtEntraIDConnectSyncSoftHardMatchingCompliance.ps1`](../../standalone-functions/Maester/Entra/Test-MtEntraIDConnectSyncSoftHardMatchingCompliance.ps1)
