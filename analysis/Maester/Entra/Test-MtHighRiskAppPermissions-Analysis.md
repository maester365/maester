# App: Check if any applications or service principals have high risk Graph permissions that can lead to direct or indirect paths
...
**Function Name:** `Test-MtHighRiskAppPermissions`
...
See the standalone compliance check function: [`Test-MtHighRiskAppPermissionsCompliance.ps1`](../../standalone-functions/Maester/Entra/Test-MtHighRiskAppPermissionsCompliance.ps1)
