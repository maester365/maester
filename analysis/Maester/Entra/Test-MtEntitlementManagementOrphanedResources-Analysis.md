# Maester: Checks if catalogs contain unused resources without associated access packages

## Overview

**Function Name:** `Test-MtEntitlementManagementOrphanedResources`
...
**Graph API Calls:**
- `identityGovernance/entitlementManagement/accessPackages/$packageId/accessPackageResourceRoleScopes?`$expand=accessPackageResourceRole,accessPackageResourceScope`
...
See the standalone compliance check function: [`Test-MtEntitlementManagementOrphanedResourcesCompliance.ps1`](../../standalone-functions/Maester/Entra/Test-MtEntitlementManagementOrphanedResourcesCompliance.ps1)
