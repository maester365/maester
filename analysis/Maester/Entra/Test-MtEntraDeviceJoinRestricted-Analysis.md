# Test-MtEntraDeviceJoinRestricted: Tests if Entra ID device join is restricted to selected users/groups or disabled.

## Overview

**Function Name:** `Test-MtEntraDeviceJoinRestricted`
...
See the standalone compliance check function: [`Test-MtEntraDeviceJoinRestrictedCompliance.ps1`](../../standalone-functions/Maester/Entra/Test-MtEntraDeviceJoinRestrictedCompliance.ps1)
