# Maester: Validates catalog resources have no stale app roles or deleted service principals

## Overview

**Function Name:** `Test-MtEntitlementManagementValidResourceRoles`
...
**Graph API Calls:**
- `servicePrincipals/$resourceOriginId`
- `identityGovernance/entitlementManagement/accessPackages/$($package.id)/accessPackageResourceRoleScopes?`$expand=accessPackageResourceRole,accessPackageResourceScope`
- `identityGovernance/entitlementManagement/accessPackageCatalogs/$catalogId/accessPackageResources`
...
See the standalone compliance check function: [`Test-MtEntitlementManagementValidResourceRolesCompliance.ps1`](../../standalone-functions/Maester/Entra/Test-MtEntitlementManagementValidResourceRolesCompliance.ps1)
