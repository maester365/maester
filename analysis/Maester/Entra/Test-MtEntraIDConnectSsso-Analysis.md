# Test-MtEntraIDConnectSsso: Ensure Microsoft Entra seamless single sign-on is disabled for all domains.

## Overview

**Function Name:** `Test-MtEntraIDConnectSsso`
...
See the standalone compliance check function: [`Test-MtEntraIDConnectSssoCompliance.ps1`](../../standalone-functions/Maester/Entra/Test-MtEntraIDConnectSssoCompliance.ps1)
