# Test-MtMdeMappedDriveScanning: Checks if full scan on mapped network drives is disabled in Microsoft Defender Antivirus policies

## Overview

**Function Name:** `Test-MtMdeMappedDriveScanning`
...
See the standalone compliance check function: [`Test-MtMdeMappedDriveScanningCompliance.ps1`](../../standalone-functions/Maester/Defender/Test-MtMdeMappedDriveScanningCompliance.ps1)
