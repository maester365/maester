# Test-MtMdeEmailScanning: Checks if email scanning is enabled in Microsoft Defender Antivirus policies

## Overview

**Function Name:** `Test-MtMdeEmailScanning`
...
See the standalone compliance check function: [`Test-MtMdeEmailScanningCompliance.ps1`](../../standalone-functions/Maester/Defender/Test-MtMdeEmailScanningCompliance.ps1)
