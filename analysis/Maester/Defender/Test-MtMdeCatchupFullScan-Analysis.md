# Test-MtMdeCatchupFullScan: Checks if catch-up full scan is disabled to avoid additional system load

## Overview

**Function Name:** `Test-MtMdeCatchupFullScan`
...
See the standalone compliance check function: [`Test-MtMdeCatchupFullScanCompliance.ps1`](../../standalone-functions/Maester/Defender/Test-MtMdeCatchupFullScanCompliance.ps1)
