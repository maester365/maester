# Test-MtMdeRealtimeMonitoring: Checks if real-time monitoring is enabled in Microsoft Defender Antivirus policies

## Overview

**Function Name:** `Test-MtMdeRealtimeMonitoring`
...
See the standalone compliance check function: [`Test-MtMdeRealtimeMonitoringCompliance.ps1`](../../standalone-functions/Maester/Defender/Test-MtMdeRealtimeMonitoringCompliance.ps1)
