# Test-MtMdeSignatureUpdateInterval: Checks if signature update interval is configured between 1-4 hours

## Overview

**Function Name:** `Test-MtMdeSignatureUpdateInterval`
...
See the standalone compliance check function: [`Test-MtMdeSignatureUpdateIntervalCompliance.ps1`](../../standalone-functions/Maester/Defender/Test-MtMdeSignatureUpdateIntervalCompliance.ps1)
