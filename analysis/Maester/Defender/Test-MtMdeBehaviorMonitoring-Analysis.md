# Test-MtMdeBehaviorMonitoring: Checks if behavior monitoring is enabled in Microsoft Defender Antivirus policies

## Overview

**Function Name:** `Test-MtMdeBehaviorMonitoring`
...
See the standalone compliance check function: [`Test-MtMdeBehaviorMonitoringCompliance.ps1`](../../standalone-functions/Maester/Defender/Test-MtMdeBehaviorMonitoringCompliance.ps1)
