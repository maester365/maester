# Test-MtMdeArchiveScanning: Checks if archive scanning is enabled in Microsoft Defender Antivirus policies

## Overview

**Function Name:** `Test-MtMdeArchiveScanning`
...
See the standalone compliance check function: [`Test-MtMdeArchiveScanningCompliance.ps1`](../../standalone-functions/Maester/Defender/Test-MtMdeArchiveScanningCompliance.ps1)
