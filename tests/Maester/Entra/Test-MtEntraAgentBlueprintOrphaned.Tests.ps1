Describe 'Maester/Entra' -Tag 'Maester', 'Entra', 'Graph', 'Agent ID' {
    It 'MT.1203: Agent Identity Blueprint Principals should have an existing Blueprint. See https://maester.dev/docs/tests/MT.1203' -Tag 'MT.1203', 'Severity:Medium', 'Preview' {
