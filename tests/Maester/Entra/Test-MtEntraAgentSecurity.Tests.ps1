Describe 'Maester/Entra' -Tag 'Maester', 'Entra', 'Graph' {
    It 'MT.1204: Agent Identities, Blueprint Principals, and Blueprints should have active, enabled owners (Preview). See https://maester.dev/docs/tests/MT.1204' -Tag 'MT.1204', 'Severity:Medium', 'Preview', 'LongRunning' {
    ...
    It 'MT.1205: Agent Identity Blueprints and Blueprint Principals should have assigned sponsors (Preview). See https://maester.dev/docs/tests/MT.1205' -Tag 'MT.1205', 'Severity:Medium', 'Preview', 'LongRunning' {
    ...
    It 'MT.1206: Enabled Agent Identities should have active sign-in activity within the last 180 days (Preview). See https://maester.dev/docs/tests/MT.1206' -Tag 'MT.1206', 'Severity:Medium', 'Preview', 'LongRunning' {
    ...
    It 'MT.1207: Foreign or multi-tenant Agent Blueprint Principals and Agent Identities should not hold privileged directory roles (Preview). See https://maester.dev/docs/tests/MT.1207' -Tag 'MT.1207', 'Severity:High', 'Preview', 'LongRunning' {
    ...
    It 'MT.1208: Agent Identity Blueprints should not have expired, excessive, or long-lived client credentials (Preview). See https://maester.dev/docs/tests/MT.1208' -Tag 'MT.1208', 'Severity:High', 'Preview', 'LongRunning' {
    ...
    It 'MT.1209: Agent Identities and Blueprint Principals should not be assigned privileged Entra directory roles (Preview). See https://maester.dev/docs/tests/MT.1209' -Tag 'MT.1209', 'Severity:High', 'Preview', 'LongRunning' {
    ...
    It 'MT.1210: Agent Users should not have privileged directory roles or membership in role-assignable groups (Preview). See https://maester.dev/docs/tests/MT.1210' -Tag 'MT.1210', 'Severity:High', 'Preview', 'LongRunning' {
    ...
    It 'MT.1211: Agent Identity Blueprints should not use the allAllowed inheritance pattern for delegated scopes or application roles (Preview). See https://maester.dev/docs/tests/MT.1211' -Tag 'MT.1211', 'Severity:High', 'Preview', 'LongRunning' {
