...
Describe "App Management Policies" -Tag "App", "Security", "All" {
    It "MT.1002: App management restrictions on applications and service principals is configured and enabled. See https://maester.dev/docs/tests/MT.1002" -Tag "L-WI", "MT.1002" -Skip:( $EntraIDPlan -ne "Governance" ) {
