...
However code review is still on-going to include the new functionality in bundled tests/azdo/adops/ADOPS.psm1 module.
...
I have included readmes in markdown format under tests/azdo.
And instead of having each test by itself, it's in a module (Code to compile and test module/functions is not included in this branch, let me know if it should be bundled or how I can adapt to how other test suits are built) imported in a BeforeAll block of the Test-Azdo.Tests.ps1