Describe "Default Authorization Settings" -Tag "AADSCA", "Security", "All" {
...
Describe "Default Settings - Consent Policy Settings" -Tag "AADSCA", "Security", "All" {
...
Describe "Default Settings - Password Rule Settings" -Tag "AADSCA", "Security", "All" {
...
Describe "Default Settings - Classification and M365 Groups" -Tag "AADSCA", "Security", "All" {
...
Describe "Default Activity Timeout" -Tag "AADSCA", "Security", "All" {
...
Describe "External Identities" -Tag "AADSCA", "Security", "All" {
...
Describe "Feature Rollout (Enabled Previews)" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - General Settings" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - Microsoft Authenticator" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - FIDO2 security key" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - Temporary Access Pass" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - Third-party software OATH tokens" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - Email OTP" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - Voice call" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - SMS" -Tag "AADSCA", "Security", "All" {
...
Describe "Authentication Method - Certificate-based authentication" -Tag "AADSCA", "Security", "All" {
...
Describe "Consent Framework - Admin Consent Request (Coming soon)" -Tag "AADSCA", "Security", "All" {
...
Describe "Azure AD Recommendations" -Tag "AADSCA", "Security", "All" {
